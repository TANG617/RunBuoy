...
The RunBuoy Skill and CLI are available to install today. Start with the complete prompt if your agent supports Skills, or use the manual flow when you want to control each command. Complete phone pairing requires an iPhone with access to the RunBuoy app for iOS 26 or later.
